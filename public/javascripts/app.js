...
mainApp.controller('acquisitionController', acquisitionController);
acquisitionController.$inject = ['$scope','UserService'];

function acquisitionController($scope,UserService) {
    var dm = this;
    dm.loggedIn = 'vijay';
